...
typedef struct _Rte_ReceiverBuffer_SWC_SOC_Algo_R_PackMeasData_Tx_Type_
{
...
}Rte_ReceiverBuffer_SWC_SOC_Algo_R_PackMeasData_Tx_Type;
typedef struct _Rte_BufferDataStructureType_
{
	VAR(Rte_ReceiverBuffer_SWC_SOC_Algo_R_PackMeasData_Tx_Type, TYPEDEF) Rte_ReceiverBuffer_SWC_SOC_Algo_R_PackMeasData_Tx ;
