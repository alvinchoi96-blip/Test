...
typedef union
{
  struct
  {
    uint32 _reserved0:27;              /*!< bit:  0..26  Reserved */
...
typedef union
{
  struct
  {
    ...
    uint32 _reserved1:8;               /*!< bit: 16..23  Reserved */
...
__STATIC_INLINE void __NVIC_SetPriority(IRQn_Type IRQn, uint32 priority)
{
  ...
  {
    SCB->SHP[(((uint32)IRQn) & 0xFUL)-4UL] = (uint8)((priority << (8U - __NVIC_PRIO_BITS)) & (uint32)0xFFUL);
  }
}
